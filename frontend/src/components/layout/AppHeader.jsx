...
export function AppHeader({ toggleSidebar }) {
  ...
  return (
    <header className="h-16 border-b border-gray-100 bg-white flex items-center justify-between px-4 sm:px-6 shadow-sm z-30 sticky top-0">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Info de usuario + avatar */}
        <div className="hidden sm:flex items-center gap-2.5">
          <div className="flex flex-col leading-tight text-right">
            <span className="text-base font-bold text-gray-800">
              {user?.nombre} {user?.apellido}
            </span>
            <span className="text-sm text-gray-400">{rolLabel}</span>
          </div>
          <div className="h-11 w-11 rounded-xl bg-orange-500 flex items-center justify-center shrink-0 shadow-md shadow-orange-200">
